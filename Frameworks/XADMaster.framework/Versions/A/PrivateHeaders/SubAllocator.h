...
static inline void InitSubAllocator(PPMdSubAllocator *self) {
    self->Init(self);
}

static inline uint32_t AllocContext(PPMdSubAllocator *self) {
    return self->AllocContext(self);
}

static inline uint32_t AllocUnits(PPMdSubAllocator *self, int num) {
    return self->AllocUnits(self, num);
}
